...
export const HomePage = () => {
  ...
  return (
    <div className="min-h-screen pt-16">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 via-white to-blue-50/30 py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-full mb-8">
              <Star size={16} fill="currentColor" />
              <span className="text-sm font-semibold">Rejoignez +2,500 étudiants</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-lg px-8 h-14"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              className="group bg-white border-2 border-blue-100 hover:border-blue-500 rounded-2xl p-8 md:p-10 cursor-pointer transition-all module-card"
            >
            ...
            <div
              ...
              className="group bg-white border-2 border-green-100 hover:border-green-500 rounded-2xl p-8 md:p-10 cursor-pointer transition-all module-card"
            >
      ...
      {/* CTA Section */}
      <section className="section-spacing bg-gradient-to-br from-blue-600 to-blue-700">
